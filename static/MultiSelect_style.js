function MultiSelectTag(e,t={shadow:!1,rounded:!0}) {
    ...
    h.textColor=h.textColor||"#FF5D29",h.borderColor=h.borderColor||"#FF5D29",h.bgColor=h.bgColor||"#FFE9E2";

    var m=new DOMParser;

    function g(e,t,l=!1){
        const n=document.createElement("li");
        n.innerHTML="<input type='checkbox' style='margin:0 0.5em 0 0' class='input_checkbox'>",n.innerHTML+=e.label,n.dataset.value=e.value;
        const a=n.firstChild;
        a.dataset.value=e.value,t&&e.label.toLowerCase().startsWith(t.toLowerCase())?p.appendChild(n):t||p.appendChild(n),l&&(n.style.backgroundColor=h.bgColor,a.checked=!0)
    }
    function f(e=null){
        for(var t of(p.innerHTML="",n))
    ...
    function C(e){
        ...
        a.addEventListener("click",(t=>{n.find((t=>t.value==e.value)).selected=!1,w(e.value),f(),E()})),t.appendChild(l),t.appendChild(a),i.append(t)
    }
    
    function L(){
        for(var e of p.children)
            e.addEventListener("click",(e=>{!1===n.find((t=>t.value==e.target.dataset.value)).selected?(n.find((t=>t.value==e.target.dataset.value)).selected=!0,c.value=null,f(),E()):(n.find((t=>t.value==e.target.dataset.value)).selected=!1,c.value=null,f(),E(),w(e.target.dataset.value))}))
        }
